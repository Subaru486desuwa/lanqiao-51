...
void time0_init()
{
//    AUXR |= 0x80;	//¶¨Ê±Ä£Ê½ÏÂ£¬1TÄ£Ê½£¬IAP15F2K61S2µ¥Æ¬»úÌØÊâ¹¦ÄÜ¼Ä´æÆ÷²»·ÖÆµ
//    TMOD &= 0xF0;      //T1ÔÚÄ£Ê½3ÏÂ±»½ûÖ¹¡£T0¹¤×÷ÔÚ·½Ê½0ÏÂ£¬16Î»×Ô¶¯ÖØ×°¶¨Ê±Æ÷
//    TL0 = 0xCD;	    	//1ms¶¨Ê±
//    TH0 = 0xD4;
//    TF0 = 0;
//    TR0 = 1;
...
void time1_init()   //¶¨Ê±Ä£Ê½
{
    AUXR |= 0x40;	//¶¨Ê±Ä£Ê½ÏÂ£¬1TÄ£Ê½£¬IAP15F2K61S2µ¥Æ¬»úÌØÊâ¹¦ÄÜ¼Ä´æÆ÷²»·ÖÆµ
    TMOD &= 0x0F;      //T1ÔÚÄ£Ê½3ÏÂ±»½ûÖ¹¡£T1¹¤×÷ÔÚ·½Ê½0ÏÂ£¬16Î»×Ô¶¯ÖØ×°¶¨Ê±Æ÷
   // TL1 = 0xAE;	    	//100us¶¨Ê±,Ê±¼ä¶Ì£¬ÊýÂë¹ÜÏÔÊ¾ÓÐÒõÓ°
   // TH1 = 0xFB;
	  TL1 = 0xCD;	    	//1ms¶¨Ê±
    TH1 = 0xD4;
    TF1 = 0;
